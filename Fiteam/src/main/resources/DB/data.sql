...
INSERT INTO CharacterCard (
    ...
    ('https://kr.object.ncloudstorage.com/fiteam-character/1_1.png', 'EPVC', '반짝이는 아이디어 조율 요정', '아이디어, 조율력, 팀 분위기 업', '외향적이고 창의적이며 계획을 중시하고 분위기를 잘 맞춤', '아이디어 공유, 팀원 간 중재, 분위기메이커', '우유부단, 결정 장애, 방향 설정 고민', 'IDAL', '실행력이 뛰어난 유형과 조합 시 조율 중심 기획력이 빛남', 'IPVL', '조용한 추진자와 기획 리더와의 조화', 'EDVL', '강한 리더십 성향과 충돌 가능', 'EDAL', '결과 중심 실행형과 협업 시 주도권 다툼 우려'),
    ('https://kr.object.ncloudstorage.com/fiteam-character/2_1.png', 'EPVL', '아이디어로 팀을 이끄는 크리에이티브 리더', '기획 리더, 창의성, 결단력', '외향적이고 계획적이며 아이디어로 리드함', '아이디어 주도, 기획 리딩, 결단력 있음', '타인 배려 부족, 독주 경향, 경청 부족', 'IPVC', '조용하지만 창의적인 유형과 시너지', 'IDVC', '실용적 실행자와 기획 균형', 'EDAL', '실행 중심 리더와 주도권 충돌', 'IDAL', '보수적인 유형과 아이디어 갈등'),
    ('https://kr.object.ncloudstorage.com/fiteam-character/3_1.png', 'EPAC', '전략적 사고로 중심을 잡는 조율 마스터', '데이터 감각, 전략 사고, 조율 능력', '외향적이고 분석적이며 계획적, 조율형', '데이터 기반 협업, 갈등 관리', '융통성 부족, 유연성 아쉬움, 새로움 부족', 'IDVC', '분석형 실무자와 안정된 기획 가능', 'IPAC', '논리적 계획과 감정 중재가 어우러짐', 'EDVL', '추진 위주 스타일과 방식 충돌', 'IDAL', '실행 중심의 직진형과 협업 시 마찰'),
    ('https://kr.object.ncloudstorage.com/fiteam-character/4_1.png', 'EPAL', '계획력 만렙! 추진력 있는 기획 리더', '기획력, 추진력, 조직력', '분석적 사고로 외향적 리딩 + 계획형 추진력', '전략 기획, 리더십 발휘', '결과 중심, 소통 부족, 과정 생략', 'IPAC', '논리적 기획자들과 전략적 호흡', 'IPAL', '차분한 실행자와 균형 있는 협업', 'EDVL', '추진 중심 리더와 주도권 충돌', 'IDVC', '조율형과의 소통 단절 가능'),
    ('https://kr.object.ncloudstorage.com/fiteam-character/5_1.png', 'EDVC', '아이디어 떠오르면 바로 실천! 실행력 천재', '실행력, 창의 아이디어, 행동 중심', '외향적이면서 아이디어 풍부, 바로 행동', '추진력, 분위기 메이커', '계획 미흡, 충동성, 지속력 부족', 'IPAL', '신중한 계획형과 조합 시 실행력 보완', 'IPVL', '차분한 리더와 안정적 협업 가능', 'EPAL', '기획형 리더와 추진 방식 충돌', 'IDAL', '내향적 실행형과 커뮤니케이션 충돌 가능'),
    ('https://kr.object.ncloudstorage.com/fiteam-character/6_1.png', 'EDVL', '속도감 있게 밀어붙이는 추진 리더', '속도 갑, 리더형, 실전 감각', '외향적이고 실행 중심 + 창의적 리더 기질', '빠른 결정과 팀 리딩', '장기 전략 부족, 속도 과함, 전략 부재', 'IPVL', '조용한 전략가와 안정적 조율', 'IPAL', '계획 중심 실행과 상호 보완', 'EPVC', '외향적 조율자와 리더십 충돌', 'IPVC', '내향적 아이디어형과 속도 차이'),
    ('https://kr.object.ncloudstorage.com/fiteam-character/7_1.png', 'EDAC', '정확하고 꼼꼼한 실무형 멀티플레이어', '실행력, 분석형, 협업 감각', '외향적, 실행형, 분석적이며 조율력도 있음', '실무 강자, 다툼 조율 잘함', '창의성 부족, 감정 무딤, 즉흥성 약함', 'IDAC', '정확하고 체계적인 실행 파트너', 'IPAL', '기획형과 실무 분담 가능', 'EPVL', '기획형 리더와 주도권 경쟁', 'EPVC', '아이디어 조율자와 창의성 방식 차이'),
    ('https://kr.object.ncloudstorage.com/fiteam-character/8_1.png', 'EDAL', '빠르게 판단하고 이끄는 실전형 해결사', '문제 해결, 신속한 판단, 목표 주도', '데이터 기반 빠른 실행, 리더십 있음', '문제 해결력, 목표 주도', '소통 부족, 무뚝뚝, 협업 어려움', 'IPAC', '논리적인 팀원과 궁합 좋음', 'IDAC', '차분하고 꼼꼼한 팀원과 상호 보완', 'EPVC', '조율형과 팀워크 방식 다름', 'IPVC', '창의적 유형과 접근 방식 충돌'),
    ('https://kr.object.ncloudstorage.com/fiteam-character/9_1.png', 'IPVC', '조용히 반짝이는 아이디어 수집가', '섬세한 아이디어, 조용한 사고, 조율력', '내향적이고 창의적이며 계획을 선호하고 조율 감각이 뛰어남', '디테일한 아이디어 제안', '표현 부족, 존재감 낮음, 설득력 약함', 'EPVL', '외향적 창의 리더와 함께 창의적 흐름을 구체화할 수 있음', 'EDVC', '즉흥 실행자와의 균형으로 실행력을 높일 수 있음', 'EDAL', '강한 주도성과 리더십이 충돌할 수 있음', 'EPAL', '실행 중심 기획형과 속도 및 방식 차이로 갈등 우려'),
    ('https://kr.object.ncloudstorage.com/fiteam-character/10_1.png','IPVL', '말 없이 믿음직한 조용한 플래너', '계획적, 책임감, 조용한 리더', '조용히 이끄는 전략가 스타일로 체계적이고 책임감이 강함', '전체 조율, 장기적 플랜 수립 능력', '거리감, 과묵함, 직접 피드백 부족', 'EDVL', '추진형과 조합 시 실행력과 전략의 균형을 맞출 수 있음', 'IPAL', '논리적 전략가와 장기 프로젝트에서 궁합이 좋음', 'EPVC', '외향적이고 즉흥적인 팀원과 리듬이 맞지 않을 수 있음', 'EDVC', '의사결정 속도 차이로 갈등 가능'),
    ('https://kr.object.ncloudstorage.com/fiteam-character/11_1.png','IPAC', '숫자와 사람 사이를 잇는 전략형 조율러', '분석적, 조율력, 해결력', '분석적이고 계획적이며 조율 능력이 뛰어난 전략형 중재자', '문제 해결, 갈등 완화 능력 탁월', '실행력 부족, 과분석, 속도 느림', 'EPAC', '논리적 계획 수립자와 함께 신중한 결정을 내릴 수 있음', 'IPAL', '분석적 리더와 꼼꼼한 프로젝트 관리에 적합', 'EDVL', '즉흥 실행형과 의사결정 속도 차이로 마찰 가능', 'EDAL', '직진형 스타일과 갈등 시 융통성 부족'),
    ('https://kr.object.ncloudstorage.com/fiteam-character/12_1.png','IPAL', '전략에 진심인 조용한 컨트롤 타워', '전략적, 판단력, 실행력', '조용하지만 전략적 사고와 정확한 판단력이 돋보이는 기획 실행자', '계획적이고 책임감 있는 실행력', '융통성 부족, 반응 느림, 유연하지 않음', 'EPAL', '기획형 리더와 전략 수립에서의 호흡이 좋음', 'EDVC', '즉흥 실행자와 협업 시 실행력을 보완받을 수 있음', 'IDVC', '창의형과의 감각적 접근에서 마찰 가능', 'EDVL', '빠른 결단이 필요한 상황에서 리더십 충돌 우려'),
    ('https://kr.object.ncloudstorage.com/fiteam-character/13_1.png','IDVC', '내공 깊은 실용파 아이디어 메이커', '실용성, 독립성, 창의력', '내향적이지만 창의성과 실행력을 동시에 갖춘 실용형 인물', '자기주도 실행력, 독립적 문제 해결 능력', '소통 부족, 협업 소극적, 고립 경향', 'EPAC', '논리적 기획자와 협업 시 실행에 힘을 실어줄 수 있음', 'IPAL', '전략적 유형과 함께 결과 중심 작업에 강함', 'EPVL', '외향적이고 주도적인 리더와의 의견 대립 가능성', 'IPAC', '분석 중심의 속도 느린 팀과 비효율 초래 가능'),
    ('https://kr.object.ncloudstorage.com/fiteam-character/14_1.png','IDVL', '묵묵히 이끄는 조용한 추진 엔진', '몰입도, 조용한 추진력, 성과 지향', '실행에 강하고 조용한 리더 기질로 몰입도가 높음', '조용한 추진력, 계획된 성과 실현 능력', '피드백 부족, 혼자 일함, 소통 아쉬움', 'EPVC', '아이디어형과 조합 시 실행으로 연결되는 시너지 가능', 'IPVL', '전략가와 함께 플랜 실행에서 균형 유지', 'EDVL', '외향적 리더와의 강한 방향성 충돌 가능', 'IPAL', '분석 중시형과 협업 시 속도 차이 발생'),
    ('https://kr.object.ncloudstorage.com/fiteam-character/15_1.png','IDAC', '데이터로 일하는 꼼꼼한 실행러', '데이터 분석, 디테일, 실행력', '실행력과 분석력을 겸비한 내향적 실무 전문가', '꼼꼼한 진행과 철저한 업무 완성도', '표현력 부족, 창의력 낮음, 감정 표현 어려움', 'EDAC', '실행 관리자와 협업 시 업무 효율 극대화', 'IPAC', '분석 조율자와 논리적 호흡이 뛰어남', 'EPVL', '외향적 리더와 감정 커뮤니케이션에서 갈등 가능', 'EPVC', '아이디어 중심 성향과 협업 시 답답함 초래'),
    ('https://kr.object.ncloudstorage.com/fiteam-character/16_1.png','IDAL', '한 마디 없이 문제를 해결하는 신뢰 리더', '책임감, 신뢰감, 문제 해결력', '실행력과 리더십, 분석력을 고루 갖춘 신뢰감 있는 내향형 리더', '책임감 있고 계획적인 업무 처리', '고립, 침묵형, 감정 공유 어려움', 'EPVC', '조율형 기획자와 함께하면 팀 안정감 상승', 'EPAC', '논리적 팀원과 문제 해결력 극대화 가능', 'EDVL', '즉흥적 추진형과 의사결정 충돌 가능', 'IDVC', '감성적·창의형과의 정서적 거리감 발생');
...
VALUES
    (1,  1, 1,  1,  'Team 1', 6, '초기 1인 팀', '대기중'),
    (2,  1, 2,  2,  'Team 2', 6, '초기 1인 팀', '대기중'),
    (3,  1, 3,  3,  'Team 3', 6, '초기 1인 팀', '대기중'),
    (4,  1, 4,  4,  'Team 4', 6, '초기 1인 팀', '대기중'),
    (5,  1, 5,  5,  'Team 5', 6, '초기 1인 팀', '대기중'),
    (6,  1, 6,  6,  'Team 6', 6, '초기 1인 팀', '대기중'),
    (7,  1, 7,  7,  'Team 7', 6, '초기 1인 팀', '대기중'),
    (8,  1, 8,  8,  'Team 8', 6, '초기 1인 팀', '대기중'),
    (9,  1, 9,  9,  'Team 9', 6, '초기 1인 팀', '대기중'),
    (10, 1, 10, 10, 'Team 10',6, '초기 1인 팀', '대기중');
...
VALUES
    (1,  1,  1, TRUE, '2025-05-10 00:00:00', FALSE, 1,  '대기중'),
    (2,  1,  2, TRUE, '2025-05-10 00:00:00', FALSE, 2,  '대기중'),
    (3,  1,  3, TRUE, '2025-05-10 00:00:00', FALSE, 3,  '대기중'),
    (4,  1,  4, TRUE, '2025-05-10 00:00:00', FALSE, 4,  '대기중'),
    (5,  1,  5, TRUE, '2025-05-10 00:00:00', FALSE, 5,  '대기중'),
    (6,  1,  6, TRUE, '2025-05-10 00:00:00', FALSE, 6,  '대기중'),
    (7,  1,  7, TRUE, '2025-05-10 00:00:00', FALSE, 7,  '대기중'),
    (8,  1,  8, TRUE, '2025-05-10 00:00:00', FALSE, 8,  '대기중'),
    (9,  1,  9, TRUE, '2025-05-10 00:00:00', FALSE, 9,  '대기중'),
    (10, 1, 10, TRUE, '2025-05-10 00:00:00', FALSE, 10, '대기중');
